#!/usr/bin/python
#
#   Copyright 2017 Martijn Grendelman <m@rtijn.net>
#
...
# System binaries for toolchain calls
        ...
        if self.setup_logging():
            ...
            while not self.stop:
                ...
                for target,summary in sry.items():
                    ...
                    print ("This is the target: %s" % safe_target)
                    print ("This is the loss: %s" % m_loss)
                    print ("This is the median: %s" % m_median)
                    print ("This is the min: %s" % m_min)
                    print ("This is the avg: %s" % m_avg)
                    print ("This is the max: %s" % m_max)
                    print ("This is the summary: %s" % summary)
